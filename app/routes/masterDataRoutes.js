...
router.post('/get-all-categories-by-brand-ids/', getBrandsByCategoryIdController);
...
router.post('/get-all-metrics-by-platform-ids/', getMetricsByPlatformIdController);
